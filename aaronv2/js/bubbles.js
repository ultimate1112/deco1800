...
function updateByCrime(crimeList) {
    ...
    addToShared(filteredBubbleValues[0]);
    addToShared(filteredBubbleValues[1]);
...
function getSmallest() {
    for (var i = 0; i < sharedDataset.length; i++) {
        if (sharedDataset[i].crimeValue === 0) {
            continue;
        }
        return sharedDataset[i].crimeValue;
    }
}
