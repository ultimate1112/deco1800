...
function bubbleSet(bubbleValues, id, length) {
    ...
    if (noBubble === false) {
        ...
        if ($('#no-bubbles').hasClass("no-bubbles-default")) {
            setNoBubblePopup();
        }
    } else {
        setNoBubblePopup();
...
function setNoBubblePopup() {
    $('#no-bubbles').toggleClass("no-height");
    $('#no-bubbles-text').toggleClass("no-height");
    $('#no-bubbles').toggleClass("no-bubbles-default");
}
